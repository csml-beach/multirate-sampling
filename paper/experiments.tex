...
show short-run visualization panels for representative cases; additional target
panels can be appended in the same format.
...
test accuracy, NLL, ECE, ESS, and mean log probability; KSD is optional and
disabled by default in this configuration. As in the UCI benchmark, all
reported summaries use the best finite-NLL checkpoint under the global
predictive stopping policy. Results are summarized with panels analogous to the
...
\begin{table}[t]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
    \multicolumn{4}{l}{\textit{breast\_cancer}} \\
    Strang-SVGD & 0.059 & 0.979 & 18.6 \\
    SVGD & 0.059 & 0.979 & 5.3 \\
    Adapt-MR-SVGD & 0.059 & 0.979 & 12.6 \\
    MR-SVGD & 0.060 & 0.977 & 18.9 \\
    \midrule
    \multicolumn{4}{l}{\textit{ionosphere}} \\
    Strang-SVGD & 0.255 & 0.900 & 4.2 \\
    SVGD & 0.255 & 0.900 & 1.1 \\
    Adapt-MR-SVGD & 0.255 & 0.900 & 2.6 \\
    MR-SVGD & 0.255 & 0.900 & 3.9 \\
    \midrule
    \multicolumn{4}{l}{\textit{a5a}} \\
    MR-SVGD & 0.336 & 0.842 & 6.4 \\
    Adapt-MR-SVGD & 0.342 & 0.838 & 12.7 \\
    SVGD & 0.374 & 0.829 & 19.7 \\
    Strang-SVGD & 0.382 & 0.829 & 30.6 \\
    \bottomrule
  \end{tabular}
  \caption{BNN particle-method summary over five seeds. For each dataset and
  method, we select the best finite-NLL checkpoint per seed and report the
  method-wise mean of that best NLL, the accuracy at that checkpoint, and the
  corresponding wall time. All four particle methods reached a finite best-NLL
  checkpoint on all five seeds; ECE is summarized in the per-dataset panels of
...
geometry induced by a global scale parameter, making it a natural timing-quality
test bed for SVGD variants.
